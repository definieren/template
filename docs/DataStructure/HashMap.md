...
struct custom_hash {
  ...
  u64 operator () (const std::pair<int, int> &x) const {
  	return (*this)(static_cast<u64>(x.first) << 32 | static_cast<u64>(x.second));
  }
};
```
